...
- Accept serial_number OR id as appliance channel identifier
...
- Caregiver activity timeline accordion (#210)
...
- Make mobile sidebar backdrop visible in dark mode (#204)
...
- Include livewire views in admin theme @source (#201)
