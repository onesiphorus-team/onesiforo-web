 ...
 *
 * Volume levels are restricted to 5 preset values: 20%, 40%, 60%, 80%, 100%.
 */
class CreateVolumeCommandAction
{
     ...
     * @var list<int>
     */
    public const array VALID_LEVELS = [20, 40, 60, 80, 100];
     ...
     * @param  int  $level  The volume level (must be 20, 40, 60, 80, or 100)
